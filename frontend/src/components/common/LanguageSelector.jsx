  ...
  return (
    <div className={`relative inline-block text-left ${className}`} ref={dropdownRef}>
      <button
        ...
        className="inline-flex items-center space-x-1.5 px-3 py-1.5 text-xs font-bold rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-sky-500/20 focus:border-slate-800 transition-all duration-150"
      >
        <Globe className="w-3.5 h-3.5 text-slate-900 flex-shrink-0" />
            ...
            return (
              <button
                ...
                className={`w-full flex items-center justify-between px-3 py-2 text-xs font-semibold transition-colors duration-150 ${
                  isSelected
                    ? 'bg-sky-50 text-slate-900 font-bold'
